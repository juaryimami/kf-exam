...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"groupCounter\": () => (/* binding */ groupCounter),\n/* harmony export */   \"slotCounter\": () => (/* binding */ slotCounter)\n/* harmony export */ });\nconst groupCounter = () => {\n  const items = [...document.querySelector('.group-container').children];\n  return items.length;\n};\nconst slotCounter = (event) => {\n  const items = [...event.target.parentNode.parentNode.firstElementChild.children];\n  return items.length;\n};\n\n\n//# sourceURL=webpack://todo-list-app/./src/modules/itemCounter.js?");
